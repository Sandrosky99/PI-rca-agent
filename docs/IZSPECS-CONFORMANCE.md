...
| 2.1 | Cobertura de pruebas [MUST] | ✅ | 7 suites en `tests/`, 214 comprobaciones. Umbral del proyecto: toda función con lógica de decisión o validación debe tener pruebas de su camino feliz, sus modos de fallo y sus entradas malformadas |
