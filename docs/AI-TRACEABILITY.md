...
| 2026-09-07 | Suites completas | Local, con dobles | `python tests/run_all.py` — 5 suites |

⚠️ **Limitación conocida:** la validación funcional se apoya en **un solo** ciclo completo
real. No es evidencia suficiente sobre la calidad del diagnóstico; ver el punto 8 de la
