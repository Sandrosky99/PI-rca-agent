...
_DIAGNOSIS_FINAL_INSTRUCTION = (
    ...
    "nada más. Nombra el mecanismo físico concreto y dónde ocurre, no la "
    "categoría genérica. Detallada se refiere a QUÉ está pasando, no a por qué "
    "lo crees: la justificación va en \"evidence\".\n"
    "- \"evidence\": un array de 1 a 4 cadenas. Cada una, UN hecho observado "
